...
public class EnergyGuiComponent extends TooltipGuiComponent {
    private static final ResourceLocation ENERGY_BAR = new ResourceLocation(MFAutomata.MODID, "textures/gui/sprites/energy_bar.png");
    private static final ResourceLocation ENERGY_BAR_EMPTY = new ResourceLocation(MFAutomata.MODID, "textures/gui/sprites/energy_bar_empty.png");
