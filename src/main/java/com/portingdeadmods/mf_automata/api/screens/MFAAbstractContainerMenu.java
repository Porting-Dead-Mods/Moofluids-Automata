...
public abstract class MFAAbstractContainerMenu<T extends ContainerBlockEntity> extends AbstractContainerMenu {
    protected final @Nullable T blockEntity;
    protected final Player player;

    public MFAAbstractContainerMenu(@Nullable MenuType<?> menuType, int containerId, Inventory inv, T blockEntity) {
    ...
    protected int getMergeableSlotCount() {
        return blockEntity == null ? 0 : blockEntity.getItemHandler().get().getSlots();
    }
